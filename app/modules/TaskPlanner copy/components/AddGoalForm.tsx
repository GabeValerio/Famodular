  ...
  return (
    <form onSubmit={handleAddGoal} className="space-y-4">
      ...
      <div className="flex gap-4 mt-6">
        <Button
          type="submit"
          className="flex-1 bg-blue-500 text-white py-3 px-4 rounded-md hover:bg-blue-600 font-medium border border-blue-600 shadow-sm transition-all duration-200"
        >
          Add Goal
        </Button>
        <Button
